...
<h1 class="text-2xl font-semibold mb-4">Add Subject</h1>
<?php if($error): ?><div class="bg-red-100 text-red-700 p-3 rounded mb-4"><?php echo $error;?></div><?php endif;?>
<form method="POST" class="space-y-4">
<input type="text" name="subject_name" placeholder="Subject Name" required class="w-full border rounded px-3 py-2"/>
<button class="w-full bg-green-600 text-white py-2 rounded">Add Subject</button>
